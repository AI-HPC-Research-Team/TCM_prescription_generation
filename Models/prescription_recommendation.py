...
class Recommender(nn.Module):
    def __init__(self):
        super().__init__()
        self.hidden1 = nn.Linear(128,512)
        ...
        self.batchnorm4 = nn.BatchNorm1d(128, affine=True)
        self.hidden5 = nn.Linear(128, 64)
        self.batchnorm5 = nn.BatchNorm1d(64, affine=True)
        self.batchnorm6 = nn.BatchNorm1d(1, affine=True)
